...
bool LaserCollision::CheckMovement(double speed, double rotation)
{
	...
	// Now this is hard coded for the laser we have, this could be done more general !!
	
 	// Find the distance at that angle (note, -Pi/2 < angle < PI/2
	// Now this is easy for our laser since it has 180 rays, -90 is first all the way to 90
	...
	// Now note, our robot is not a point but as it moves it forms a tube, so we in fact
